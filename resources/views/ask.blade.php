    ...
    <main>
        ...
        <div class="ask-wrapper">
            <div class="couch-wrapper">
                <img src="/images/form-couch.png" alt="form">
            </div>
            <div class="content-wrapper">
                <section class="preview-section">
                    <div class="preview-image">
                        <img src="{{ asset('images/preview-form.png') }}" alt="Preview Product">
                    </div>
                ...
                <form action="post" class="ask-form">
                    <div class="title">
                        <h1>Pertanyaan</h1>
                    ...
                    <div class="form-wrapper">
                        <textarea name="ask-vendor" id="ask-vendor" placeholder="Tuliskan Pertanyaan"></textarea>
                        <button type="submit">
                            Kirim Pesan
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_172_972" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                    <rect width="24" height="24" fill="#D9D9D9" />
                                </mask>
                                <g mask="url(#mask0_172_972)">
                                    <path d="M3 20V4L22 12L3 20ZM5 17L16.85 12L5 7V10.5L11 12L5 13.5V17Z" fill="#FCF8F3" />
                                </g>
                            </svg>
                        </button>
                    </div>
